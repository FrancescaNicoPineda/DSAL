class Employee_Info:
    def __init__(self):
        ...
        self.emp_name = ""
        self.emp_code = ""
        self.salary1_cut_off = ""

    def get_emp_data(self, company_name, emp_department, emp_name, emp_code, salary1_cut_off):
        self.company_name = company_name
        self.emp_department = emp_department
        self.emp_name = emp_name
        self.emp_code = emp_code
        self.salary1_cut_off = salary1_cut_off
    ...
    def desiplay_data(self):
        ...
        print("Cut-Off Date: ", self.salary1_cut_off)
...
class Employee_Salary:
    ...
    def get_absences_deduction(self, emp_rate_per_hour, emp_number_of_absences):
        self.emp_absences = emp_number_of_absences * emp_rate_per_hour
